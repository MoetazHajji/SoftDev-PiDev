...
public class Reservation {
   ...
   int refact;
   int reftra;
   private static int idcll;

    public static int getIdcll() {
        return idcll;
    }

    public static void setIdcll(int idcll) {
        Reservation.idcll = idcll;
    }
    ...
    public Reservation(int id, int prix_res, int nbr_places, String nom_cl, String prenom_cl, String date_res, int tel_cl, String email_cl, int refact, int reftra,int id_client) {
        this.id = id;
