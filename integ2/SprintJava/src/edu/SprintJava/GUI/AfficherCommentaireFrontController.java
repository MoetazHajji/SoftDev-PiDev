...
import static edu.SprintJava.GUI.FrontRestauController.index;
...
public void liteCommentaire(){
     ...
     ObservableList<Pane> Panes = FXCollections.observableArrayList();
        for (Commentaire p3 :  C.getListCommentaireByID(index))  {
           //System.out.println(p3);
            FileInputStream F1 = null;
                ...
                panequantitet.setLayoutY(150);
                panequantitet.setPrefWidth(panequantitet.getWidth() + 160);
                panequantitet.setPrefHeight(panequantitet.getHeight() + 150);
       ...
       //  C.supprimerCommentaireR(p3);
                ...
                try {
                  ...
                  listcmntr.setPrefHeight(listcmntr.getHeight() + 1200);
            listcmntr.setPrefHeight(listcmntr.getWidth() + 1200);
    ...
    @FXML
    private void RetourFrontRestau(ActionEvent event) throws IOException {
