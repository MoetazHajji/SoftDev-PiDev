...
public class FrontActiviteController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
       ...
       // listViewRestau.setItems(refresh);
            ActiviteCRUD sp = new ActiviteCRUD();
        ObservableList<Pane> Panes = FXCollections.observableArrayList();
        for (Activite p3 :  sp.listerActivite2())  {
           // System.out.println(p3);
            ...
            try {
                ...
                final Button btnCommenter = new Button("Welcome");    
           ...
           Stage window = (Stage) ((Node) event.getSource()).getScene().getWindow();
            ...
            System.out.println(ex.getMessage());
                ...
                final Button btncommentaire = new Button("Voir Transport disponibles");    
                ...
                btncommentaire.setStyle("-fx-background-color: #B0E0E6;");
                 ...
                 btncommentaire.setOnAction(event -> {
                     index = p3.getReference();
                    FXMLLoader LOADER = new FXMLLoader(getClass().getResource("AffichTraCL.fxml"));
                    try {
                        Parent root = LOADER.load();
                        Scene sc = new Scene(root);
                        AffichTraCLController cntr = LOADER.getController();
                        Stage window = (Stage) ((Node) event.getSource()).getScene().getWindow();
                        window.setScene(sc);
                        window.show();
                    } catch (Exception ex) {
            ...
            URL fxURL = getClass().getResource("AjouterReservation.fxml");
            Parent root = FXMLLoader.load(fxURL);
            Scene scene = new Scene(root);
            Stage stage = new Stage();
            stage.setScene(scene);
           ...
           Stage window = (Stage) ((Node) event.getSource()).getScene().getWindow();
            ...
            System.out.println(ex.getMessage());
                ...
                Label quant2 = new Label(String.valueOf(p3.getNom()));
                ...
                Label adress = new Label(p3.getLocalisation());  
                Text payT = new Text("Pays : ");
                Label pay = new Label(Integer.toString(p3.getNbre_places()));
                 Text telT = new Text(" Tel : ");
                Label tey = new Label(p3.getDate());
                Text Prixh = new Text(" Tel : ");
                Label Prixha = new Label(Integer.toString(p3.getPrix()));
                
                nomt.setLayoutX(300);
                nomt.setLayoutY(20);
                nom.setLayoutX(250);
                nom.setLayoutY(10);
                prixt.setLayoutX(300);
                prixt.setLayoutY(35);
                prix.setLayoutX(350);
                prix.setLayoutY(25);
                ...
                tey.setLayoutX(150);
                tey.setLayoutY(85);
                Prixh.setLayoutX(100);
                Prixh.setLayoutY(115);
                Prixha.setLayoutX(150);
                Prixha.setLayoutY(125);
                ...
                Prixh.setStyle("-fx-font-weight: bold;-fx-fill : #ce3b67");
                pane2.getChildren().addAll(nomt, prixt,AdressT, payT,telT,nom, prix,adress,pay,tey, panequantitet,Prixha);
                Panes.add(pane2);
                 } catch (Exception ex) {
                }
            } catch (Exception ex) {
...
//listViewRestau.setItems(sortedData);
    ...
    @FXML
    private void RetourClientPannel(ActionEvent event) throws IOException {
