        ...
        Buttondeletecommande(){
         cellButton.setOnAction(new EventHandler<ActionEvent>(){
                ...
                public void handle(ActionEvent t) {
                    try {
                        // get Selected Item
                        Commande Commandecourante = (Commande) Buttondeletecommande.this.getTableView().getItems().get(Buttondeletecommande.this.getIndex());
                        ...
                        list.remove(Commandecourante);
                        service_pr.supprimer(Commandecourante);
