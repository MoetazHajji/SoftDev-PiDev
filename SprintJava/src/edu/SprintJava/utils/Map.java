...
public class Map extends MapView {
    ...
    public void generateSimplePath(LatLng start, LatLng end, Boolean markers) {
        ...
        Polyline polyline = new Polyline(mapp);
    ...
    /**
     * Generate a circle area on the mapp
     *
     * @param center LatLong of the center of the mapp
     * @param radius on meters
     */
    public void generateArea(LatLng center, Double radius) {
        Circle circle = new Circle(mapp);
    ...
    /**
     * Create a new mapp panel whit the param Name
     *
     * @param pString Name for the mapp
     */
    public Map(String pString) {
        ...
        setOnMapReadyHandler(new MapReadyHandler() {
            ...
            public void onMapReady(MapStatus status) {
                ...
                if (status == MapStatus.MAP_STATUS_OK) {
                    ...
                    mapp.setOptions(mapOptions);
                    mapp.setCenter(new LatLng(42.045527, -88.037659));
                    mapp.setZoom(10);
    ...
    public static void main(String[] args) {
        ...
        final Map example = new Map("test");
        example.generateMarker(mapp.getCenter());
