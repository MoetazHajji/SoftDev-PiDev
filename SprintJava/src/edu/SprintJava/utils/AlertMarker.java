...
public class AlertMarker {
    ...
    public static void showTrayMessage(String title, String message) {
        try {
            ...
            BufferedImage image = ImageIO.read(AlertMarker.class.getResource(ControleSaisie.ICON_IMAGE_LOC));
    ...
    private static void styleAlert(Alert alert) {
        ...
        ControleSaisie.setStageIcon(stage);

        DialogPane dialogPane = alert.getDialogPane();
        dialogPane.getStylesheets().add(AlertMarker.class.getResource("/css/dark-theme.css").toExternalForm());
